...
public class PdfController {
    ...
    public FileSystemResource generateDocument(@RequestBody CvDocumentDTO cvDocumentDTO) throws Exception {
        return new FileSystemResource(pdfFacade.generatePdf(cvDocumentDTO));
